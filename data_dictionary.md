...
事件，说明存在一行对应多辆车、或同一事件拆成多行的情况。因此：
...
- **坐标**：社区质心为各社区记录坐标的**中位数**，作为**固定地理常量**使用
  （社区的物理位置不随报告窗口变化），因此不属于"事件派生特征"，不引入未来
  信息泄漏。
...
| 情形 | 数量 | 处理 |
|---|---|---|
| 完全重复行（当前导出字段下） | 495 行 | 不未经核实删除；重复事件可能对应多辆车 |
...
| `data/raw/bicycle.csv` | `9776cf291e81e622db8a060c244b1e1dfe6ddc71593a282011caa80516f88cd9` |
| `data/raw/bicycle_enhanced.csv` | `9c1f4ac4313e6bc232bd881560a5856d71aef70f87f0654835e26e8d8bc6fc4b` |
